...
function App(){
  const [page,setPage]=useState(()=>{
    ...
    return window.location.hash.replace('#','') || pathRoutes[window.location.pathname] || 'home';
  });
